 ...
 */
@TargetApi(Build.VERSION_CODES.CUPCAKE) @SuppressLint("NewApi") public class MyMediaController extends MediaController {
    ...
    @SuppressLint("NewApi") public MyMediaController(Context context, VideoView videoView , Activity activity) {
        super(context);
...
//            mOperationBg.setImageResource(R.drawable.video_volumn_bg);
     ...
     * @param percent
     */
    @TargetApi(Build.VERSION_CODES.CUPCAKE) @SuppressLint("NewApi") private void onBrightnessSlide(float percent) {
        if (mBrightness < 0) {
